...
public class ArticleService {
    ...
    @Transactional
    public Long articleSave(ArticleForm articleForm){
        UserAccount account = em.find(UserAccount.class, "min");
    ...
    @Transactional
    public void articleCommentSave(Long id, ArticleCommentDto articleDto) {
        UserAccount account = em.find(UserAccount.class, "min");
        Article article = em.find(Article.class, id);
